...
"[externals]/openai [external] (openai, cjs)", ((__turbopack_context__, module, exports) => {

const mod = __turbopack_context__.x("openai", () => require("openai"));

module.exports = mod;
}),
"[project]/AI Phone Agent App/pages/api/voice/webhook.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$twilio__$5b$external$5d$__$28$twilio$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/twilio [external] (twilio, cjs)");
;
const VoiceResponse = __TURBOPACK__imported__module__$5b$externals$5d2f$twilio__$5b$external$5d$__$28$twilio$2c$__cjs$29$__["default"].twiml.VoiceResponse;
async function handler(req, res) {
    ...
    try {
        if (step === 'initial') {
            ...
            if (SpeechResult) {
                try {
                    const OpenAI = __turbopack_context__.r("[externals]/openai [external] (openai, cjs)");
                    ...
                    if (classification === 'urgent') {
                        ...
                        twiml.say({
                            voice: 'alice'
                        }, "This call has been identified as potential spam. Goodbye.");
                        twiml.hangup();
                    } else {
                        twiml.say({
                            voice: 'alice'
                    ...
                    if (isUrgent) {
                        twiml.say({
                            voice: 'alice'
                        }, "I understand this is urgent. Connecting you now.");
                        twiml.dial(process.env.MY_REAL_PHONE_NUMBER || '+15550000000');
                    } else {
                        twiml.say({
                            voice: 'alice'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__58130910._.js.map